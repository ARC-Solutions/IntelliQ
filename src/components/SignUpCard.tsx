...
const SignUpCard = () => {
    ...
    const handleSubmit = async (isGoogleOAuth: boolean = false) => {
        ...
        if (isANewUser) {
            confirmPassword === password ? signupUsingEmail({
                email, password
    ...
    let style = {
        maskImage, WebkitMaskImage: maskImage, // // Adjusted background color with lower alpha, for example 0.5 for 50% transparency
    ...
    return (<div onMouseMove={onMouseMove}
        ...
        <Tabs defaultValue="signup" className='w-auto sm:w-[450px]' role='tablist'>
            <TabsList
                className='grid w-full grid-cols-2 border-none rounded-lg shadow-[0_0px_20px_-4px_rgba(0,0,0,0.24)] shadow-primary bg-[#0e0e0e]' role='presentation'>
                <TabsTrigger
                    value='signup'
                    className="data-[state=active]:bg-[#c8b6ff]"
                    role='tab' aria-controls='signup-tab'
                >
                    Sign Up
                </TabsTrigger>
                <TabsTrigger
                    value='signin'
                    className="data-[state=active]:bg-[#c8b6ff]"
                    role='tab' aria-controls='signin-tab'
                >
                    Sign In
                </TabsTrigger>
            </TabsList>
            <TabsContent value='signin' role='tabpanel' aria-labelledby='signin-trigger'>
                <Card
                    ...
                    <CardHeader className='pb-5'>
                        ...
                        <Button
                            ...
                            aria-labelledby='signin-google-button'
                        >
                        ...
                        >
                            <div>
                                ...
                                <div className='relative mb-5'>
                                    ...
                                    <div id='password-toggle-description' className='sr-only'>
            ...
            <TabsContent value='signup' role='tabpanel' aria-labelledby='signup-trigger'>
                <Card
                    className='w-auto sm:w-[450px] border-none rounded-lg p-4 shadow-[0_0px_20px_-4px_rgba(0,0,0,0.24)] shadow-primary'>
                    <CardHeader className='pb-5'>
                        <CardTitle className='text-3xl'>ARC-Solutions</CardTitle>
                        ...
                        <Button
                            ...
                            aria-labelledby='signup-google-button'
                        >
                            <div className='text-3xl place-content-center'>
                                <FcGoogle size=''/>
                            </div>
                    ...
                    <CardContent>
                        ...
                        >
                            ...
                            <Button
                                ...
                                onClick={() => setIsAnewUser(!isANewUser)}
                                aria-label='Sign Up'
                                aria-describedby='signup-button'
                            >
                                Sign Up
                            </Button>
                        </form>
