            ...
            <div className='mt-4'>
                    ...
                    render={({ field }) => (
                        <FormItem className='flex flex-row items-center justify-between'>
                            <div className='space-y-0.5'>
                                <FormLabel className='text-base font-semibold'>Essential</FormLabel>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex flex-row items-center justify-between'>
                            <div className='space-y-0.5'>
                                <FormLabel className='text-base font-semibold'>Marketing</FormLabel>
                                <FormDescription className='text-sm'>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex flex-row items-center justify-between'>
                            <div className='space-y-0.5'>
                                <FormLabel className='text-base font-semibold'>Analytics</FormLabel>
                                <FormDescription className='text-sm'>
